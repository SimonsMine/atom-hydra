...
import Hydra from 'hydra-synth-mine'
//import Hydra from '../../hydra-synth'
import OscLoader from './osc-loader'
//import SourceClips from './source-clips'
const loop = require('raf-loop')
import P5 from './p5'
import CssManip, { CssConstants } from './css-manip.js'
...
export default class Main {
  ...
  toggleVisibility(hide = true) {
    ...
    if (atom.packages.isPackageActive('atom-hydra-mine')) {
